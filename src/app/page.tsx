...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-[#0B0B0D] text-white overflow-x-hidden selection:bg-[#2A30FF] selection:text-white">
      ...
      {/* Page 5: Experience Section (Main Page Scroll Driven Timeline) */}
      <ExperienceSection />
    </main>
  );
}

// Page 5: Experience Section Component with Page Scroll Progression
function ExperienceSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen bg-[#0B0B0D] bg-grid-pattern py-20 sm:py-28 px-6 sm:px-10 md:px-14 flex flex-col justify-center overflow-hidden border-t border-white/10"
    >
      {/* Top Right Brush SVG */}
      <svg
        className="absolute -top-30 -right-30 md:-top-32 md:-right-32 w-56 h-56 md:w-80 md:h-80 pointer-events-none opacity-80 text-[#1E1D69] -rotate-12 z-0"
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto">
        ...
        <FadeIn direction="left" delay={100}>
          <h2 className="font-pixel text-4xl sm:text-6xl md:text-7xl leading-tight uppercase text-white mb-12 sm:mb-16 tracking-wider">
            Experience
          </h2>
        </FadeIn>
